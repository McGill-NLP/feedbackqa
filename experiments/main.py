...
from feedbackQA.data.predict import generate_embeddings, Predictor, PredictorWithOutlierDetector
...
def main():
    ...
    parser.add_argument("--best_domain_idx", type=str, choices=['0','1','2','3','4'])
...
def init_model(
    ...
    monitor_metric = 'val_acc_{}'.format(best_domain_idx)
    ...
    early_stopping = EarlyStopping(
        monitor_metric, mode="max", patience=hyper_params["patience"]
    )
