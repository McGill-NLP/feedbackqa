...
class Predictor:
    ...
    def __init__(self, retriever_trainee):
        ...
        self.max_passage_len = 512#self.retriever_trainee.retriever.max_passage_len
        try:
    ...
    def generate_predictions(self, json_file, predict_to, multiple_thresholds, write_fix_report):
        ...
        relevance_scores_list, predictions, questions, sources, normalized_scores, indices_of_correct_passage = res
        return {'Australia': predictions}, {'Australia': indices_of_correct_passage}, questions
    ...
    def compute_results(self, json_data, passage_id2index, source2passages):
        ...
        return relevance_scores_list, predictions, questions, sources, normalized_scores, indices_of_correct_passage
